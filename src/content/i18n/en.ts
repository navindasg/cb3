...
export const en: GameText = {
  ...
  'item.mantleSword.desc': "The sword from over Grandma's mantle, down at last. Older than it looks and lighter than it should be, and it swings a little heavier for everything you have ever eaten. It was only ever waiting for you.",
  ...
  'dialogue.grandma.mantleGiven1': 'The mantle looks bare without it. Good.',
  'dialogue.grandma.mantleGiven2': 'It was only ever waiting for you. Mind you eat, now. It swings heavier the more you do.',
  ...
  'death.tollGiantLoss': 'You size up the toll giant. He is a mountain that knits. Not today. Pay the toll.',
  'death.reefDrift': 'You drift forever. A gummy alien waves politely.',
  'death.sourbeardCannon': 'Sourbeard apologizes for the cannonball. He does not mean it.',
  'death.sourbeardBoarding': 'Sourbeard reads your blade like a book, and closes it. He wants you awake for this.',
  'death.kraken': 'An arm the size of a mainmast folds you off the shell. The far one. The one you could never reach.',
  'death.sourDissolve': 'You have been politely dissolved.',
